...
#define STRING_CONFIG_H_AUTHOR "(Heydar, Ender-5 Pro)" // Who made the changes.
...
#define NOZZLE_TO_PROBE_OFFSET_Y -10
#define NOZZLE_TO_PROBE_OFFSET_Z -0.56
#define NOZZLE_TO_PROBE_OFFSET { NOZZLE_TO_PROBE_OFFSET_X, NOZZLE_TO_PROBE_OFFSET_Y, NOZZLE_TO_PROBE_OFFSET_Z }//{ 10, 10, 0 }
...
#define XY_PROBE_FEEDRATE (2*133*60)//(133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (2*4*60)//(4*60)
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   10//2 // Z Clearance for Deploy/Stow
...
#define Z_PROBE_LOW_POINT          -2//-1 // Farthest distance below the trigger-point to go before stopping
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (X_CENTER)// - NOZZLE_TO_PROBE_OFFSET_X) // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT (Y_CENTER)// - NOZZLE_TO_PROBE_OFFSET_Y) // Y point for Z homing
#endif

// Homing speeds (linear=mm/min, rotational=°/min)
#define HOMING_FEEDRATE_MM_M { (2*20*60), (2*20*60), (2*4*60) }//{ (20*60), (20*60), (4*60) }
...
#define PREHEAT_1_TEMP_HOTEND 220//185
#define PREHEAT_1_TEMP_BED     65//45
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MAX_POS), 20 }//{ (X_MIN_POS + 10), (Y_MAX_POS - 10), 20 }
